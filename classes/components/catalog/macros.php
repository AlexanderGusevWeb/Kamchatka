<?php
	...
	class CatalogMacros {
		...
		public function getCategoryList(
			$template = 'default', $rootIdOrList = false, $limit = false, $ignorePaging = false, $level = 0
		) {
			$module = $this->module;
		 ...
		 * @throws publicException если не удалось получить объект страницы по id = $categoryId
		 */
		public function getSmartCatalog($template = 'default', $categoryId, $limit = 0, $ignorePaging = false, $level = 1, $fieldName = false, $isAsc = true) {
			/** @var CatalogMacros|catalog $module */
			$module = $this->module;
